package com.cleaning.cleanify.reservation.controller;
...
public class ReservationController {
	...
	public void cancelRegularReservation(@PathVariable Long id) {
		reservationService.cancelRegularReservation(id);
	}
}
